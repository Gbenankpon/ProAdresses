...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $utilisateurs = $em->getRepository('ProAddressUserBundle:Utilisateur')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ProAddress\UserBundle\Form\UtilisateurType', $utilisateur);
    ...
    {
        $deleteForm = $this->createDeleteForm($utilisateur);
        $editForm = $this->createForm('ProAddress\UserBundle\Form\UtilisateurType', $utilisateur);
