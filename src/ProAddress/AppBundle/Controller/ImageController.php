...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('ProAddressAppBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('ProAddress\AppBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('ProAddress\AppBundle\Form\ImageType', $image);
